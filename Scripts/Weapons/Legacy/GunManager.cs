        	...
        	private void Shot() {
        		...
        		if (enemy != null) {
        			...
        			if (Physics.Raycast (ray, direction, out hit, raycastDistance)) {
                        ...
                        if (coll.transform.root.gameObject.GetComponent<Health> ()) {
                            coll.transform.root.gameObject.GetComponent<Health> ().ApplyDamage (damage);
                        } else if (coll.transform.root.gameObject.transform.root.GetComponent<Health> ()) {
                            coll.transform.root.gameObject.transform.root.GetComponent<Health> ().ApplyDamage (damage);
        				}
