...
namespace Pandora.Controllers {
    ...
    public class MovementController: MonoBehaviour {
        ...
        public string runAnimation = "camera_run";
        public string calmAnimation = "camera_sway";
        ...
        [HideInInspector] public bool aimWalk = false;
        ...
        void FixedUpdate() {
            ...
            if (grounded) {
                ...
                if (!toggleRun)
                    speed = (InputManager.GetButton("Run") && crouching == false && aimWalk == false)? runSpeed : walkSpeed;
        ...
        void Update () {
            if (toggleRun && grounded && InputManager.GetButtonDown ("Run"))
                speed = (speed == walkSpeed && aimWalk == false)? runSpeed : walkSpeed;
        }
    }
}